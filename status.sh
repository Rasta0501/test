...
github_prefix="https://h.186588.xyz/hfJ8Ffi6DC7fbp8btKyp/https://raw.githubusercontent.com/CokeMine/ServerStatus-Hotaru/master"
...
Download_Server_Status_server() {
  cd "/tmp" || exit 1
  [[ ${mirror_num} == 2 ]] && bundle_link="https://cokemine.coding.net/p/hotarunet/d/ServerStatus-Hotaru/git/archive/master/?download=true" || bundle_link="https://h.186588.xyz/hfJ8Ffi6DC7fbp8btKyp/https://github.com/CokeMine/ServerStatus-Hotaru/archive/master.zip"
  [[ ${mirror_num} == 2 ]] && github_link="https://hub.fastgit.org" || github_link="https://h.186588.xyz/hfJ8Ffi6DC7fbp8btKyp/https://github.com"
...
Install_jq() {
  [[ ${mirror_num} == 2 ]] && {
    ...
    github_link="https://h.186588.xyz/hfJ8Ffi6DC7fbp8btKyp/https://github.com"
    raw_link="https://h.186588.xyz/hfJ8Ffi6DC7fbp8btKyp/https://raw.githubusercontent.com"
  }
  if [[ ! -e ${jq_file} ]]; then
    if [[ ${bit} == "x86_64" ]]; then
      jq_file="${file}/jq"
